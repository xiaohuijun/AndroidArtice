...
public class ViewSkeletonScreen implements SkeletonScreen {
    ...
    private ShimmerFrameLayout generateShimmerContainerLayout(int skeletonResId) {
        ShimmerFrameLayout shimmerFragmentLayout = (ShimmerFrameLayout) LayoutInflater.from(mActualView.getContext()).inflate(R.layout.skeleton_layout_shimmer, mParentView, false);
