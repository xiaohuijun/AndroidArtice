package com.xj.ui_lib.caterpillarIndicator;
...
public class CaterpillarIndicator extends LinearLayout implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    private int mTabLeftAndRightPadding;
    /**
     * item count
     */
    ...
    public CaterpillarIndicator(Context context, AttributeSet attrs) {
        ...
        mTabLeftAndRightPadding = a.getDimensionPixelOffset(R.styleable.CaterpillarIndicator_slide_tab_left_right_padding, dip2px(0));
    ...
    protected void add(String label, int i) {
        ...
        view.setPadding(mTabLeftAndRightPadding, 0, mTabLeftAndRightPadding, 0);
